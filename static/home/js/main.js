...
// Screen Slider — disabled (replaced by custom spotlight video carousel)
...
// Fix Header Js — skip new .nb pill navbar (handled by its own scroll logic)
$(window).scroll(function(){
  var $hdr = $('header').not('.nb');
  if ($(window).scrollTop() >= 250) {
      $hdr.addClass('fix_style');
  }
  else {
      $hdr.removeClass('fix_style');
  }
